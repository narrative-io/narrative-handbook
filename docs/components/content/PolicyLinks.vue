    ...
    <span>
      <icon name="openmoji:locked" />
       {{ policyName }}:
        ...
        <ProseA :href="githubPolicyUrl">Annotated<icon name="openmoji:github" /></ProseA> 
        <icon name="majesticons:more-menu-vertical" />
        <ProseA :href="githubPolicyNotesUrl">Notes<icon name="openmoji:github" /></ProseA> 
        <icon name="majesticons:more-menu-vertical" />
        <ProseA href="https://app.drata.com/policy-builder/5">Drata Policy<icon name="carbon:ibm-cloud-security-compliance-center" /></ProseA>
    </span>
</template>
